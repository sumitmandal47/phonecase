        ...
        <div className="sm:col-span-12 md:col-span-9 text-base">
          ...
          <div className="mt-8 ">
            ...
            <div className="mt-8 flex justify-end pb-12 ">
              <Button onClick={() => handleCheckout()} className="px-4 sm:px-6 lg:px-8 cursor-pointer "> Check out <ArrowRight className="h-4 w-4 ml-1.5 inline" /> </Button>
            </div>
          </div>
        </div>
      </div>
